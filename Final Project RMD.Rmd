...
$$0.05 = P(\psi > 0) = P(\frac{1 - 2\pi_0}{1-\pi_0} > 0) = P(1 - 2\pi_0 > 0) = P(2\pi_0 < 1) = P(\pi_0 < 0.5)$$
Similarly:
...
$$ 0.05 = P(\psi > -0.5) = P(\frac{1 - 2\pi_0}{1-\pi_0} > -0.5) = P(1 - 2\pi_0 > -0.5 + 0.5 \pi_0) = P(1.5 \pi_0 < 2.5) = P(\pi_0 < 0.6)$$
Similarly:
...
```{r Bayesian uniform figure, echo=FALSE, fig.width=5, fig.height=4}
...
```{r Bayesian study figure, echo=FALSE, fig.width=5, fig.height=4}
...
```{r Bayesian med0 figure, echo=FALSE, fig.width=5, fig.height=4}
...
```{r Bayesian pessimistic figure, echo=FALSE, fig.width=5, fig.height=4}
...
&= \frac{P(\text{covid} | \text{vaccinated})}{P(covid)} \\
&= \frac{P(\text{covid} | \text{vaccianted})}{P(\text{covid} | \text{vaccianted})P(vaccinated) + P(\text{covid} | \text{placebo})P(placebo)} \\
