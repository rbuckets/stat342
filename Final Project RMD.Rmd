...
The following table displays the median, the 95% confidence interval, and the $P(\psi < 0.3)$ (p-value) of the posterior distribution for each of the prior distributions we outlined in the Statistical Methods section:
...
$Beta(1, 1)$ & $0.946707$ & $(0.9009794, 0.9750466)$ & $1.9422e-28$ \\ \hline
...
$Beta(134.47, 89.76)$ & $0.752294$ & $(0.3068438, 0.5407399)$ & $0.01986187$ \\ \hline
\end{tabular}
\end{table}

Below, we plot the prior and posterior distributions for each of our four tested Beta prior distributions. Note that more informative prior distributions (in blue) have less spread, and thus are more highly concentrated around their centers.
